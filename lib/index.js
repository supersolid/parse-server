...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // ParseServer - open-source compatible API Server for Parse apps
...
var _ParseServer = function () {
  function _ParseServer(_ref) {
    ...
    _classCallCheck(this, _ParseServer);
    ...
    var pushControllerAdapter = (0, _AdapterLoader.loadAdapter)(push && push.adapter, _ParsePushAdapter2.default, push);
  ...
  _createClass(_ParseServer, [{
    key: 'app',
    get: function get() {
      return _ParseServer.app(this.config);
    }
  }], [{
    key: 'app',
    ...
    key: 'ParseServer',
    value: function ParseServer(options) {
      var server = new _ParseServer(options);
      return server.app;
    }
  }, {
...
var runServer = function runServer(options) {
  return _ParseServer.ParseServer(options);
};
