  ...
  function ParseServer(_ref) {
    var _ref$appId = _ref.appId,
      ...
      passwordResetSuccess: undefined
        ...
        _ref$persistSchemaCac = _ref.persistSchemaCache,
        persistSchemaCache = _ref$persistSchemaCac === undefined ? false : _ref$persistSchemaCac,
    ...
    var databaseController = new _DatabaseController2.default(databaseAdapter, new _SchemaCache2.default(cacheController, schemaCacheTTL, persistSchemaCache));
    ...
    _cache2.default.put(appId, {
      ...
      persistSchemaCache: persistSchemaCache
    });
