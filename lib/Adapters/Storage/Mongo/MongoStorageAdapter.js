...
var MongoStorageAdapter = exports.MongoStorageAdapter = function () {
  ...
  _createClass(MongoStorageAdapter, [{
    ...
    key: 'createObject',
    value: function createObject(className, object, schema) {
    ...
    value: function deleteObjectsByQuery(className, query, schema) {
      return this.adaptiveCollection(className).then(function (collection) {
    ...
    value: function updateObjectsByQuery(className, query, schema, update) {
    ...
    value: function findOneAndUpdate(className, query, schema, update) {
      var mongoUpdate = (0, _MongoTransform.transformUpdate)(className, update, schema);
      var mongoWhere = (0, _MongoTransform.transformWhere)(className, query, schema);
      return this.adaptiveCollection(className).then(function (collection) {
    ...
    key: 'upsertOneObject',
    value: function upsertOneObject(className, query, schema, update) {
      var mongoUpdate = (0, _MongoTransform.transformUpdate)(className, update, schema);
      var mongoWhere = (0, _MongoTransform.transformWhere)(className, query, schema);
      return this.adaptiveCollection(className).then(function (collection) {
    ...
    key: 'find',
    value: function find(className, query, schema, _ref3) {
      var skip = _ref3.skip;
    ...
    value: function ensureUniqueness(className, fieldNames, schema) {
    ...
    key: 'count',
    value: function count(className, query, schema) {
      return this.adaptiveCollection(className).then(function (collection) {
