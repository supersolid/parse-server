...
var transformInteriorValue = function transformInteriorValue(restValue) {
  if ((typeof restValue === 'undefined' ? 'undefined' : _typeof(restValue)) === 'object' && Object.keys(restValue).some(function (key) {
...
var parseObjectKeyValueToMongoObjectKeyValue = function parseObjectKeyValueToMongoObjectKeyValue(className, restKey, restValue, schema) {
  // Check if the schema is known since it's a built-in field.
...
function parseObjectToMongoObjectForCreate(className, restCreate, schema) {
  ...
  for (var restKey in restCreate) {
    var _parseObjectKeyValueT = parseObjectKeyValueToMongoObjectKeyValue(className, restKey, restCreate[restKey], schema);
  ...
  var _ret = function () {
    switch (typeof mongoObject === 'undefined' ? 'undefined' : _typeof(mongoObject)) {
      ...
      case 'object':
        ...
        restObject = untransformACL(mongoObject);
