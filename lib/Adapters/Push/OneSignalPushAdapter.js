...
var OneSignalPushAdapter = exports.OneSignalPushAdapter = function (_PushAdapter) {
  _inherits(OneSignalPushAdapter, _PushAdapter);
  ...
  function OneSignalPushAdapter() {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(OneSignalPushAdapter).call(this, pushConfig));

    _this.https = require('https');

    _this.validPushTypes = ['ios', 'android'];
    _this.senderMap = {};
    _this.OneSignalConfig = {};
    ...
    _this.OneSignalConfig['appId'] = pushConfig['oneSignalAppId'];
    _this.OneSignalConfig['apiKey'] = pushConfig['oneSignalApiKey'];

    _this.senderMap['ios'] = _this.sendToAPNS.bind(_this);
    _this.senderMap['android'] = _this.sendToGCM.bind(_this);
    return _this;
  }
