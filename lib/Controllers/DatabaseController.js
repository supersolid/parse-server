...
DatabaseController.prototype.loadSchema = function () {
  ...
  var acceptor = arguments.length <= 0 || arguments[0] === undefined ? function () {
    return true;
  } : arguments[0];
...
DatabaseController.prototype.update = function (className, query, update) {
  ...
  return this.loadSchema(acceptor).then(function (s) {
    ...
    var mongoWhere = _this3.transform.transformWhere(schema, className, query, { validate: !_this3.skipValidation });
    if (options.acl) {
      mongoWhere = _this3.transform.addWriteACL(mongoWhere, options.acl);
    }
    mongoUpdate = _this3.transform.transformUpdate(schema, className, update, { validate: !_this3.skipValidation });
    if (options.many) {
...
DatabaseController.prototype.destroy = function (className, query) {
  ...
  return this.loadSchema().then(function (s) {
    ...
    return _this5.adapter.adaptiveCollection(className);
  }).then(function (collection) {
    var mongoWhere = _this5.transform.transformWhere(schema, className, query, { validate: !_this5.skipValidation });
    if (options.acl) {
      mongoWhere = _this5.transform.addWriteACL(mongoWhere, options.acl);
    }
...
DatabaseController.prototype.create = function (className, object) {
  ...
  return this.validateClassName(className).then(function () {
    ...
    return _this6.adapter.adaptiveCollection(className);
  }).then(function (coll) {
    var mongoObject = _this6.transform.transformCreate(schema, className, object);
...
DatabaseController.prototype.deleteEverything = function () {
  ...
  return this.adapter.allCollections().then(function (collections) {
  ...
  return this.loadSchema(acceptor).then(function (s) {
    ...
    if (options.sort) {
      ...
      for (var key in options.sort) {
        var mongoKey = _this9.transform.transformKey(schema, className, key);
    ...
    var mongoWhere = _this9.transform.transformWhere(schema, className, query);
    if (!isMaster) {
      mongoWhere = _this9.transform.addReadACL(mongoWhere, aclGroup);
    }
    if (options.count) {
