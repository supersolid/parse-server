...
var systemClasses = ['_User', '_Installation', '_Role', '_Session', '_Product'];
...
var permissionKeyRegex = [userIdRegex, roleRegex, publicRegex];
...
var CLPValidKeys = ['find', 'get', 'create', 'update', 'delete', 'addField'];
var DefaultClassLevelPermissions = CLPValidKeys.reduce(function (perms, key) {
  perms[key] = {
    '*': true
  };
  return perms;
